...
void ofx2DMappingView::addOwnShape(int index){//add what type of image
	//index represents different shapes
	ctrl->getProjector(0)->copyShape(ctrl->getOptions().at(index));
