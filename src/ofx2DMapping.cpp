...
bool ofx2DMapping::isShowingControls(){
...
void ofx2DMapping::addToView(int index){
	view.addOwnShape(index);
}

void ofx2DMapping::setPosition(ShapeProperty *sp,int index){
	view.getFormMapping()->setNewPosition(sp,index);
}
